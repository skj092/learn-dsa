...
def create_list(values_array):
    dummy = l1 = Node(x=0)
    # Step 1: Create the nodes
    for val_arr in values_array:
        l1.next = Node(val_arr[0])
        l1 = l1.next
    # Step 2: Update the random pointing
    temp = dummy.next
    random_values = [v[1] for v in values_array]

    i = 0
    while dummy.next:
        dummy.next.random = random_values[i]
